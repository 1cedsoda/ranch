...
function sendMessage(setMessages : Dispatch<SetStateAction<JSX.Element>>, messages : JSX.Element, currentLetter : string, letter : MutableRefObject<string>)
{
        ...
        setMessages(
            ...
            <div className={classNames(styles.messageDiv)}>
                <svg fill="#000000" width="2.5rem" height="2.5rem" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text x="20" y="25" fill="white" text-anchor="middle">{currentLetter}</text>
                </svg>
...
export default function Chatbox()
{
    ...
    document.addEventListener('keydown', function(event) {
        ...
        {
            sendMessage(setMessages, messages, letter.current, letter);
        }
    });
    ...
    return (
        <div>
            ...
            <div className={classNames(styles.messagebox)}>
                ...
                <img src="/send.svg" alt="Send Logo" className={classNames(styles.messageboxIcon)} onClick={() => sendMessage(setMessages, messages, letter.current, letter)}/>
            </div>
        </div>
    )
}